# Indent + AWS Lambda and GitHub Issues

This repository contains an integration between GitHub Issues and [Indent](https://indent.com). Once deployed, you will be able to use this integration with Indent to:
...
<details><summary><strong>3. Connecting to GitHub Issues</strong></summary>
...
Visit <a href="https://indent.com/docs/integrations/github" target="_blank">this link</a> to our documentation for information on setting up GitHub Secrets in this repository.
